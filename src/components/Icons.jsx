// Lightweight inline SVG icons used across empty states and UI accents.
// Centralizing these avoids relying on emoji glyphs, which don't render
// consistently across OS/browser font sets (e.g. Windows + some browsers).
...
export const SearchOffIcon = ({ size = 56 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const MapOffIcon = ({ size = 56 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
